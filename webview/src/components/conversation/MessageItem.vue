    ...
    <div class="floor-container">
      ...
      <div class="floor-sender-column">
        <div class="sender-avatar" :class="message.role">
          <!-- 用户：精巧的个人轮廓 SVG -->
          <svg v-if="message.role === 'user'" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="floor-content-column">
        <header class="floor-header">
          ...
          <span v-if="streaming" class="floor-status-badge">正在输入</span>
        </header>
